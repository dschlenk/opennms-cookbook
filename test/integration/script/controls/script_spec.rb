control 'script' do
  ...
  describe scriptd_engine('java') do
    it { should exist }
    its('class_name') { should eq 'com.game.core.physics.CollisionManagerr' } # Or correct this if it's wrong
  ...
  # Only include this if the script in the system actually contains literal \n characters
  # Otherwise, remove or replace with a version that uses actual newlines
