control 'edit_threshd_package_services' do
  describe threshd_package('cheftest2') do
    ...
    its('services') { should eq [{ 'name' => 'SNMP', 'interval' => 300_000, 'status' => 'off', 'params' => { 'thresholding-group' => 'cheftest2' } }, { 'name' => 'ICMP', 'interval' => 300_000, 'status' => 'on', 'params' => { 'thresholding-group' => 'cheftest3' } }] }
  end
end
