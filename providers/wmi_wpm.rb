...
action :create do
  raise("Missing wmi-collection #{@current_resource.collection_name}.") unless @current_resource.collection_exists
...
def load_current_resource
  @current_resource = Chef::Resource.resource_for_node(:opennms_wmi_wpm, node).new(@new_resource.name)
