...
def load_current_resource
  ...
  unless system_definition_file.nil?
    @current_resource.system_def_exists = true
    if groups_in_system_definition?(node['opennms']['conf']['home'], @current_resource.name, system_definition_file, @current_resource.groups)
