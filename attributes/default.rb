...
# yum repo stuff
default['yum']['opennms']['key_url']                      = 'https://yum.opennms.org/OPENNMS-GPG-KEY'
default['yum']['opennms-stable-common']['baseurl']        = 'https://yum.opennms.org/stable/common'
default['yum']['opennms-stable-common']['failovermethod'] = 'roundrobin'
default['yum']['opennms-stable-rhel9']['baseurl']         = 'https://yum.opennms.org/stable/rhel9'
default['yum']['opennms-stable-rhel10']['baseurl'] = 'http://yum.opennms.org/stable/rhel9'
default['yum']['opennms-stable-rhel9']['failovermethod'] = 'roundrobin'
default['yum']['opennms-stable-rhel10']['failovermethod'] = 'roundrobin'
default['yum']['opennms-obsolete-common']['baseurl']        = 'https://yum.opennms.org/obsolete/common'
default['yum']['opennms-obsolete-common']['failovermethod'] = 'roundrobin'
default['yum']['opennms-obsolete-rhel9']['baseurl']         = 'https://yum.opennms.org/obsolete/rhel9'
default['yum']['opennms-obsolete-rhel9']['failovermethod']  = 'roundrobin'
default['yum']['opennms-snapshot-common']['baseurl']        = 'https://yum.opennms.org/snapshot/common'
default['yum']['opennms-snapshot-common']['failovermethod'] = 'roundrobin'
default['yum']['opennms-snapshot-rhel9']['baseurl']         = 'https://yum.opennms.org/snapshot/rhel9'
default['yum']['opennms-snapshot-rhel9']['failovermethod']  = 'roundrobin'
default['yum']['opennms-snapshot-rhel10']['baseurl']         = 'https://yum.opennms.org/snapshot/rhel10'
default['yum']['opennms-snapshot-rhel10']['failovermethod']  = 'roundrobin'
default['yum']['opennms-oldstable-common']['baseurl']        = 'https://yum.opennms.org/oldstable/common'
default['yum']['opennms-oldstable-common']['failovermethod'] = 'roundrobin'
default['yum']['opennms-oldstable-rhel9']['baseurl']         = 'https://yum.opennms.org/oldstable/rhel9'
...
default['opennms']['repos']['platforms'] = %w(common rhel9 rhel10)
