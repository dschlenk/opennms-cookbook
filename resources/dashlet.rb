...
attribute :boost_duration, kind_of: Fixnum, default: 0
attribute :boost_priority, kind_of: Fixnum, default: 0
attribute :duration, kind_of: Fixnum, default: 15
attribute :priority, kind_of: Fixnum, default: 5
