...
action :create do
  converge_if_changed do
    ...
    model_import_root = REXML::Document.new(model_import(new_resource.foreign_source_name,  "opennms_import").message).root
    ...
    model_import(new_resource.foreign_source_name, "opennms_import").message model_import_root.to_s
