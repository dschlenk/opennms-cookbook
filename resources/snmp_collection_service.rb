...
# Use this LWRP to include a SNMP collection in the referenced collectd
...
# collection elements using the snmp_collection and snmp_collection_group
# LWRPs. The package is created with the collection_package LWRP.
actions :create
...
attribute :interval, kind_of: Fixnum, default: 300_000, required: true
...
attribute :port, kind_of: Fixnum, default: 161
