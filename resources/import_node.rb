...
load_current_value do |new_resource|
  node_assets = {}
  node_category = []
  model_import = REXML::Document.new(model_import_Node_init(new_resource.name, new_resource.foreign_source_name).message).root unless model_import_Node_init(new_resource.name, new_resource.foreign_source_name).nil?
...
action :create do
  converge_if_changed do
    model_import_Node_init(new_resource.name, new_resource.foreign_source_name)
