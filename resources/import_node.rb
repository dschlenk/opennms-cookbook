...
load_current_value do |new_resource|
  node_assets = {}
  node_category = []
  model_import = REXML::Document.new(model_import(new_resource.name, "opennms_import_node").message).root if model_import(new_resource.name, "opennms_import_node").nil?
