...
property :type, kind_of: String, equal_to: %w(specific daily weekly monthly), required: true, identity: true
...
property :times, kind_of: Array, required: true, identity: true
